...
// ----------------------------------------------------------
    ...
    private void FindTarget()
    {
        ...
        {
            int targetIndex = targetsInRange.Length - 1;
            // Choosing index 0 of list ensures targeting the first target in the group, not the last
            target = targetsInRange[targetIndex].transform;
